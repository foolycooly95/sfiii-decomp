...
const APPEAR_DATA appear_data[] = {
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 0 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 1 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 2 },
    { 0, 0xFF84, 0x0100, -1, 0x84, 12, 3 },
    { 144, 0xFF00, 0x0100, -1, 0x00, 0, 4 },
    { 0, 0x0120, 0x0001, 1, 0x20, 0, 5 },
    { 0, 0xFF08, 0x0100, -1, 0x08, 0, 6 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 7 },
    { 0, 0xFFC2, 0x0100, -1, 0xC2, 0, 8 },
    { 200, 0xFFA8, 0x0100, -1, 0xA8, 16, 9 },
    { 0, 0xFF28, 0x0100, -1, 0x20, 16, 10 },
    { 0, 0xFF9A, 0x0100, -1, 0x9A, 0, 1 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 12 },
    { 0, 0xFFEF, 0x0100, -1, 0xEF, 0, 1 },
    { 384, 0xFFA8, 0x0100, -1, 0xA8, 0, 14 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 15 },
    { 0, 0xFF80, 0x0100, -1, 0x80, 0, 16 },
    { 0, 0xFEF0, 0x0100, -2, 0xD0, 0, 13 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 16 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 17 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 21 },
    { 0, 0xFFD0, 0x0100, -1, 0xD0, 0, 18 },
    { 0, 0xFF88, 0x0100, -1, 0x88, 0, 1 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 23, 3 },
    { 0, 0x0100, 0x0100, 1, 0x00, 0, 20 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 24 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 25 },
    { 0, 0xFFA0, 0x0100, -1, 0xA0, 0, 26 },
    { 0, 0xFFA0, 0x0100, -1, 0xA0, 0, 27 },
    { 0, 0x7F8, 0x0000, 00, 0xA8, 0, 26 },
    { 0, 0x00F8, 0x0000, 0, 0xF8, 0, 27 },
    { 0, 0xFF90, 0x0100, -1, 0x90, 0, 28 },
    { 0, 0xFF91, 0x0100, -1, 0x91, 0, 1 },
    { 0, 0xFFD0, 0x0100, -1, 0xD0, 18, 3 },
    { 0, 0xFFA0, 0x0100, -1, 0xA0, 23, 3 },
    { 0, 0xFFCB, 0x0100, -1, 0xCB, 21, 3 },
    { 0, 0xFFCB, 0x0100, -1, 0xCB, 22, 3 },
    { 0, 0xFFB8, 0x0100, -1, 0xB8, 20, 38 },
    { 0, 0xFFAC, 0x0100, -1, 0xAC, 22, 3 },
    { 0, 0xFFAC, 0x0100, -1, 0xAC, 22, 3 },
    { 0, 0xFF00, 0x0100, -1, 0x00, 0, 29 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 30 },
    { 0, 0xFFC0, 0x0100, -1, 0xC0, 0, 31 },
    { 0, 0xFEFE, 0x0100, -2, 0xFE, 0, 32 },
    { 0, 0xFF00, 0x0100, -1, 0x00, 0, 33 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 34 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 35 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 16, 3 },
    { 0, 0xFFE8, 0x0100, -1, 0xE8, 0, 36 },
    { 0, 0xFFE8, 0x0100, -1, 0xE8, 0, 37 },
    { 0, 0xFE40, 0x0100, -2, 0x40, 0, 38 },
    { 0, 0xFFB8, 0x0100, -1, 0xB8, 17, 3 },
    { 0, 0xFF08, 0x0100, -1, 0x08, 0, 40 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 0, 41 },
    { 0, 0xFFA8, 0x0100, -1, 0xA8, 17, 3 }
};
