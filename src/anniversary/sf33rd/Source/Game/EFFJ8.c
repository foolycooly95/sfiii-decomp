...
const s16 effj8_timer_tbl[8] = { 0x003c, 0x0078, 0x00b4, 0x005a, 0x0096, 0x001e, 0x00dc, 0x00a0 };

const s16 effj8_y_tbl[8] = { 0x0080, 0x0050, 0x0060, 0x00a0, 0x00b0, 0x0070, 0x0090, 0x00a8 };
