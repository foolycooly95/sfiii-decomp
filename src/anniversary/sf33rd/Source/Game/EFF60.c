...
// INCLUDE_RODATA("asm/anniversary/nonmatchings/sf33rd/Source/Game/EFF60", flash_0000);

const s16 flash_0000[10] = { 0x0000, 0x0002, 0x012c, 0x01af, 0x0050, 0x0052, 0x0001, 0x0000, 0x0000, 0x0003 };

// INCLUDE_RODATA("asm/anniversary/nonmatchings/sf33rd/Source/Game/EFF60", flash_0001);

const s16 flash_0001[10] = { 0x0000, 0x0002, 0x012c, 0x01ff, 0x00b8, 0x0052, 0x0002, 0x0000, 0x0000, 0x0003 };

// INCLUDE_RODATA("asm/anniversary/nonmatchings/sf33rd/Source/Game/EFF60", flash_0002);
