...
const s16 eff12_data_tbl2[16] = {
    0x0000, 0x0002, 0x212c, 0x022f, 0x0040, 0x0048, 0x0002, 0x0000,
    0x0000, 0x0002, 0x212c, 0x01cf, 0x0070, 0x0048, 0x0004, 0x0000
};

const s16 eff12_data_tbl3[24] = {
    0x0000, 0x0001, 0x012c, 0x01f0, 0x0040, 0x0056, 0x0002, 0x0000,
...
const s16 eff12_data_tbl4[24] = {
    0x0000, 0x0002, 0x012c, 0x01ff, 0x0000, 0x000b, 0x0005, 0x0000,
...
const s16 eff12_data_tbl5[16] = {
    0x0000, 0x0002, 0x212c, 0x023f, 0x0050, 0x004a, 0x0014, 0x0000,
